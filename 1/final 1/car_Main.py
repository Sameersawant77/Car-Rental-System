...
database = "booking")
# This is just a connection
booking_cursor = con3.cursor()
# if (con3):
#     # Carry out normal procedure
#     print("Connection successful 3")
# else:
#     # Terminate
#     print("Connection unsuccessful 3")
...
def car_Booking(y1,y2):
    ...
    def booking_db():
        ...
        booking_cursor.execute(booking_query,(y1,y2,calpick_start,caldrop_end,msg))
    ...
    def payment(x_pay):
        ...
        payment_Window.geometry(center_window(300,200,root.winfo_screenwidth(),root.winfo_screenheight()))
...
def car_Display(x):
    ...
    query_car_id = "SELECT `ID` FROM `rental_car_details`"
...
def change_password():
    ...
    # Enter new pass ety
    ety_chg_pass = Entry(chg_pass_Window)
    ...
    # Ener pass conf ety
    ety_chg_pass_conf = Entry(chg_pass_Window)
